...
- After every ~10 entries in `.claude/state/implementation-log.jsonl` (orchestrator counts and triggers).
...
`simplifier` agent writes to `.claude/state/simplifier-findings.md`:
