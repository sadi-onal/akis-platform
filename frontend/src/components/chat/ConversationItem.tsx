...
interface ConversationItemProps {
  ...
  collapsed?: boolean;
  /**
   * When set, the row belongs to an Engineer Rental Mode session. Sidebar
   * shows a wrench badge so the user can tell it apart from a plain chat
   * (BUG-24 / #434). Navigation stays on `/chat/<id>` — the chat page itself
   * surfaces a banner linking back to the live session.
   */
    ...
    <div className="group relative">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          {engineerSessionId && (
            <span
              className="flex h-3.5 w-3.5 flex-shrink-0 items-center justify-center text-[#07D1AF]"
              aria-label="Mühendis Modu oturumuna ait"
              title="Mühendis Modu oturumuna ait"
            >
