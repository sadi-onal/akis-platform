/**
 * EmptyStateCard — demo-template card shown at the root /chat pane whenever
 * no conversation is active (no `conversationId` and no `pendingConv`). Not
 * gated on "first-time" — returning users with prior sohbetler also see it
 * so the demos always give them a concrete starting point.
 *
 * Two interactions:
...
const TodoIcon = () => (
  <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
    <path
      ...
      d="M9 12.75l2.25 2.25L15 11.25M4.5 6.75A2.25 2.25 0 016.75 4.5h10.5a2.25 2.25 0 012.25 2.25v10.5a2.25 2.25 0 01-2.25 2.25H6.75a2.25 2.25 0 01-2.25-2.25V6.75z"
    />
  </svg>
);
...
const CurrencyIcon = () => (
  <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 6v12m4-9a3 3 0 00-3-3h-2a3 3 0 000 6h2a3 3 0 010 6h-2a3 3 0 01-3-3"
    />
  </svg>
);
...
const MarkdownIcon = () => (
  <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9zM8.25 13.5l1.5 1.5 3-3m1.5 0v6"
    />
  </svg>
);
